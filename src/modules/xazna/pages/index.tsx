...
import { useGetXaznaHistory } from "../hooks/queries"
...
const PaymentHistory: React.FC = () => {
  ...
  const { data: paymentHistory, isFetching } = useGetXaznaHistory({
    page: page - 1,
    size,
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-teal-50 to-blue-50 p-6 rounded-2xl border border-teal-100">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Xazna to'lovlar tarixi</h1>
            <p className="text-gray-600 mt-1">Xazna orqali amalga oshirilgan to'lovlar</p>
          </div>
        </div>
