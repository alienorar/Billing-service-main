      ...
      <Form form={form} name="discount_form" layout="vertical" onFinish={onFinish} className="mt-6">
        ...
        <Form.Item className="mb-0 mt-8">
          <Button
            ...
            className="h-14 px-6 bg-gradient-to-r from-teal-500 to-blue-600 hover:from-teal-600 hover:to-blue-700 border-0 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-200"
          >
