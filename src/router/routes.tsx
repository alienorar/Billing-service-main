...
export const adminRights = [
    ...
    { path: '/super-admin-panel/payment-history', label: 'Click payment', icon: <FaRegCreditCard style={{ fontSize: "22px" }} /> },
    { path: '/super-admin-panel/transaction-history', label: 'Transaction history', icon: <FaHourglassEnd style={{ fontSize: "22px" }} /> },
    { path: '/super-admin-panel/students-statistics', label: 'Student statistics', icon: <FaSignal style={{ fontSize: "22px" }} /> },
